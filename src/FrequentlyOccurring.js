...
export function getFrequentlyOccurringEvents() {
    ...
    return [
        ...
        {id:"bt", isChecked:false,placement:"pool", title:"Sister Julienne says \"my dear\"", tags:_SR_J},
        {id:"c9", isChecked:false,placement:"pool", title:"Sister Hilda calls someone \"pet\" or \"lamb\"", tags:_SR_H},
