...
export function getFrequentlyOccurringEvents() {
    ...
    return [
        ...
        {id:"a4", isChecked:false,placement:"pool", title:"Sister Monica Joan eats cake/sweets", tags:_SR_MJ},
        {id:"a5", isChecked:false,placement:"pool", title:"Sister Julienne is asked for help/advice", tags:_SR_J},
        ...
        {id:"aa", isChecked:false,placement:"pool", title:"Someone is referred to as being \"in the family way\"", tags:ALL},
        ...
        {id:"ae", isChecked:false,placement:"pool", title:"Twins or triplets are born", tags:ALL},
        {id:"af", isChecked:false,placement:"pool", title:"Father attends birth", tags:ALL},
        {id:"ag", isChecked:false,placement:"pool", title:"Phyllis is annoyed at people being late", tags:_PHYLLIS},
        {id:"ah", isChecked:false,placement:"pool", title:"Mother Mildred unknowningly offends someone", tags:_MO_M},
        ...
        {id:"aq", isChecked:false,placement:"pool", title:"Undiagnosed twins", tags:ALL},
        ...
        {id:"au", isChecked:false,placement:"pool", title:"Sister Winifred prepares/mentions preparing food for someone", tags:_SR_W},
        ...
        {id:"bc", isChecked:false,placement:"pool", title:"Someone in the cast sings", tags:ALL},
        ...
        {id:"bg", isChecked:false,placement:"pool", title:"Other word for \"toilet\" is used (lav, privy, khazi etc)", tags:ALL},
        {id:"bh", isChecked:false,placement:"pool", title:"Board game is played at Nonnatus House", tags:ALL},
        {id:"bi", isChecked:false,placement:"pool", title:"Someone gives birth", tags:ALL},
        ...
        {id:"bu", isChecked:false,placement:"pool", title:"Violet is working in her haberdashery", tags:_VI},
        ...
        {id:"bz", isChecked:false,placement:"pool", title:"Fred is repairing something", tags:_FRED},
        ...
        {id:"ce", isChecked:false,placement:"pool", title:"There is a closeup of hands", tags:ALL},
        ...
        {id:"cl", isChecked:false,placement:"pool", title:"There is a cub scout meeting", tags:ALL},
